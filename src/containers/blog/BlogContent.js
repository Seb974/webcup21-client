  ...
  return (
      ...
      <div className="container">
        <div className="row">
            { farms.map(farm => {
                return (
                  <div key={ farm.id } className="col-lg-4 col-md-6 col-sm-6 col-12">
                      <article  className="blog__3">
                          <div className="thumb">
                            <Link to={process.env.PUBLIC_URL + "/blog-post/" + farm.id }>
                              <img
                                // src={process.env.PUBLIC_URL + "/images/blog/md-img/4.jpg" }
                                src={ isDefined(farm.picture) ? api.API_DOMAIN + "/uploads/pictures/" + farm.picture.filePath : process.env.PUBLIC_URL + "/images/blog/md-img/4.jpg" }
                                alt=""
                              />
                            </Link>
                          </div>
